...
/**
 * AdminManageStaffController(Class): Controller class for the admin manage staff view. Contains methods to initialize the view by reading staff members from file and displaying them as buttons in the defined VBox.
 * @author Justin_Scott, 11/20/2025
 */
public class AdminManageStaffController{
   
    /**
    * buttonsAreaBoxStaff(Variable): Holds the list of buttons representing staff members.
    */
    @FXML
    ...
    /**
     * initialize(Method): initializer method for AdminManageStaffController to read staff members from file and display them as buttons in the defined VBox.
